...
export default function InventoryCombatModal({gameplay, setSoundEffectAction} : {gameplay: Engine, setSoundEffectAction: (effect: string | null) => void}) {
    ...
    const decrementInventory = useInventoryStore(state => state.decrementInventory);
    ...
    function handleItemUse(item: Store) {
        ...
        gameplay.handlePlayerCombatChoices(combatItem, setSoundEffectAction)
