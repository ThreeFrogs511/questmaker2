...
export default function ClassSelection(
  ...
  useEffect(() => {
    if (currentUser.user_class) {
      ...
      const chosen = classes.find((n) => n.class === currentUser.user_class);
    ...
    <>
      <section
        ...
        <div
          ...
          {classes.map((c) => (
            <Button
              key={c.class}
              bg="black"
              textColor={currentUser.user_class === c.class ? "yellow" : "white"}
              borderColor={currentUser.user_class === c.class ? "yellow" : "white"}
              data-id="class-option"
              onPointerDown={() => setCurrentUser(prev => ({...prev, user_class: c.class}))}
        ...
        <Card
          ...
          {!currentUser.user_class? "Select a class to view its description.": classDescription}
        </Card>
      </section>
    </>
  );
