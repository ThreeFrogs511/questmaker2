...
export default class Combat {
    ...
    async handleUserTurn(item:any, node:keyof Nodes | undefined, setSoundEffect:any) {
      ...
      return new Promise<void>( async (resolve) => {
        ...
        if (item.type === "item") {
          ...
          this.useAttack = new useAttackAction(item, setSoundEffect, this.encounter.ac ?? 10);
    ...
    const userAction = new useConsumableAction(item, setSoundEffect, this.currentUser)
