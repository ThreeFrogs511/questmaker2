...
export default class Campaign {
    ...
    filterTheChoices(setAllChoices:any, choices:any, userChoices:any) {

      const availableChoices = choices.filter((n: any) => {
        if (!userChoices.includes(n.text)) {
          return n 
        }
      })
    ...
    handleChoicesResult(setCurrentNode:any, setAbilityCheckData:any, check:string | undefined, next:string | undefined) {
